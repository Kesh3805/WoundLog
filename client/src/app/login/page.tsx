    ...
    <main>
      <div className="w-screen h-screen min-h-screen flex items-center justify-center bg-gradient-to-br from-[#18141a] via-[#0a0a0a] to-[#1a0d13] relative overflow-hidden">
        ...
        <GlassCard className="max-w-lg w-full mx-auto p-10 rounded-3xl shadow-2xl bg-[#18141a]/90 dark:bg-[#18141a]/95 backdrop-blur-md border border-[#3a1a2c] flex flex-col items-center gap-6 relative z-20">
          <h1 className="font-poetic text-4xl md:text-5xl text-center mb-2 text-[#f5f3f7] drop-shadow-lg tracking-tight">Sign In</h1>
          <p className="font-poetic text-lg text-center mb-6 opacity-80 text-[#bfaec9]">Welcome back, wounded soul.</p>
      ...
      />
        ...
        {loading ? "Logging in..." : "Login"}
            ...
            <a href="/register" className="text-accent underline text-sm text-center font-poetic hover:text-accent/80 transition-all">Don't have an account? Register</a>
    </form>
        </GlassCard>
        <style jsx global>{`
          .grain-bg {
